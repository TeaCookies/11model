...
ALTER TABLE product ADD(prodquantity NUMBER(3) NOT NULL);
...
CREATE TABLE transaction ( 
	...
	order_data 			DATE,
	dlvy_date 				DATE,
	tranquantity 			NUMBER(3) NOT NULL,
	tranprice 					NUMBER(10) NOT NULL,
	PRIMARY KEY(tran_no)
);
...
ALTER TABLE users ADD(mileage NUMBER(6));
