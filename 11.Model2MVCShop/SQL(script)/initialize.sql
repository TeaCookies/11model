...
ALTER TABLE product ADD(prodquantity NUMBER(3,0) NOT NULL);
...
CREATE TABLE transaction ( 
	...
	order_data 	 		DATE,
	dlvy_date 		 		DATE,
	tranquantity 	 		NUMBER(3,0) NOT NULL,
	tranprice 		 		NUMBER(10,0) NOT NULL,
	tranmileage 	 		NUMBER(6,0),
	PRIMARY KEY(tran_no)
);
...
ALTER TABLE users ADD(mileage NUMBER(6,0));
UPDATE users SET mileage=5000;
